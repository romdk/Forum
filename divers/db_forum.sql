...
-- Listage des données de la table forum_roman.message : ~32 rows (environ)
...
-- Listage des données de la table forum_roman.sujet : ~21 rows (environ)
...
-- Listage des données de la table forum_roman.visiteur : ~12 rows (environ)
/*!40000 ALTER TABLE `visiteur` DISABLE KEYS */;
INSERT INTO `visiteur` (`id_visiteur`, `mail`, `pseudonyme`, `motDePasse`, `dateInscription`, `role`, `statut`, `image`) VALUES
	(20, 'test@test.fr', 'Roman', '$2y$10$LA2wXr6x/xg2Wjhxy141gOI0xZsSIsXu2Ml6EsGv4kZsF9PxTcRfS', '2022-12-07 18:13:32', 'Admin', 0, 'image0.jpg'),
	(24, 'BoisBannana@test.fr', 'BoisBannana', '$2y$10$5TUF5L79MZu2JU2tdyM5PuTbAz9Js4Hu09ECgQ.5gP9VX/IUvEx96', '2022-12-09 17:12:54', 'User', 0, 'default.png'),
	(25, 'PepitoCloud@test.fr', 'PepitoCloud', '$2y$10$pLzHKCVjr30dnP6EgXbdduqZl1axp6qC566Jisj8N9aePpnWFLob6', '2022-12-09 17:13:20', 'User', 0, 'default.png'),
	(26, 'BraveSushi@test.fr', 'BraveSushi', '$2y$10$5oqIlmulUitvO0PRb0IixuxYDxSNcT5ZjI.CoRNIcS03QdN60klA.', '2022-12-09 17:13:33', 'User', 0, 'default.png'),
	(27, 'Mr.Moon@test.fr', 'Mr.Moon', '$2y$10$X6lyme1GhTODBJKG7eTtTuxcWwkDBFUxfyfwFK9wV7r4K9QV5bLFi', '2022-12-09 17:14:01', 'User', 0, 'default.png'),
	(28, 'PoneyCheat@test.fr', 'PoneyCheat', '$2y$10$vplxeXLvTXQ.pBFS4Xx.KeywCY6eeCrL4wvzJy0R6UGAfW3TBXOLe', '2022-12-09 17:14:22', 'User', 0, 'default.png'),
	(29, 'CaptainCovid@test.fr', 'CaptainCovid', '$2y$10$t//AGHhidmNmIs2G25ObYuZfPirnl4Fu29BDvlWxL24sZcx1ZCInW', '2022-12-09 17:15:04', 'User', 1, 'default.png'),
	(30, 'ShoqapikSol@test.fr', 'ShoqapikSol', '$2y$10$zdwAVFpHGPQhIR7Nqfpym.U4pqQqNPrBSs9r85ZyaJmL3D7TrX51O', '2022-12-09 17:17:40', 'User', 0, 'default.png'),
	(31, 'BronzeBear@test.fr', 'BronzeBear', '$2y$10$ZpA6pqFQBixNaBAMKJaWber7GYPl1fCUHY/PnAifctbERUjyiW/7a', '2022-12-09 17:17:52', 'User', 0, 'default.png'),
	(32, 'PotatoCraby@test.fr', 'PotatoCraby', '$2y$10$v9ToD2fqv4HHJvlx4si2ceD.lSIJI3HG08wWfXwW4VQB5Ug1XmRfO', '2022-12-09 17:18:10', 'User', 1, 'default.png'),
	(33, 'test_banni@test.fr', 'test_banni', '$2y$10$IiBNLMQN11xX.S10xZY9se5nX4/5ewtgMtqYYH4Ex3cpHDt0QNX/C', '2022-12-12 17:06:04', 'User', 1, 'default.png'),
	(34, 'testChangement@test.fr', 'test pseudo', '$2y$10$fY.3KGjh5hFDHTOX2qFMTet/WdSauZi6URtPflwPapEsag4yrSdXq', '2022-12-13 19:16:00', 'User', 0, 'default.png');
