...
-- Listage des données de la table forum_roman.message : ~9 rows (environ)
...
INSERT INTO `message` (`id_message`, `visiteur_id`, `sujet_id`, `message`, `dateCreation`, `nbVote`) VALUES
	...
	(32, 20, 2, 'test', '2022-12-08 08:59:51', 1);
...
INSERT INTO `sujet` (`id_sujet`, `visiteur_id`, `categorie_id`, `titre`, `dateCreation`, `statut`) VALUES
	...
	(5, 4, 2, 'Cum esse doloremque aut atque', '2022-11-29 08:28:34', 1),
	...
	(45, 21, 2, 'test lock', '2022-12-07 20:52:06', 1);
...
-- Listage des données de la table forum_roman.visiteur : ~6 rows (environ)
/*!40000 ALTER TABLE `visiteur` DISABLE KEYS */;
INSERT INTO `visiteur` (`id_visiteur`, `mail`, `pseudonyme`, `motDePasse`, `dateInscription`, `role`, `statut`) VALUES
	(1, 'mail1@test.com', 'EpicFish', '1234', '2022-11-29 08:27:07', 'User', 0),
	(2, 'mail2@test.com', 'PythonLord', '1234', '2022-11-29 08:27:14', 'User', 0),
	(3, 'mail3@test.com', 'DiabèteWait', '1234', '2022-11-29 08:27:21', 'User', 0),
	(4, 'mail4@test.com', 'XPickle', '1234', '2022-11-29 08:27:28', 'User', 0),
	(20, 'test@test.fr', 'Roman', '$2y$10$LA2wXr6x/xg2Wjhxy141gOI0xZsSIsXu2Ml6EsGv4kZsF9PxTcRfS', '2022-12-07 18:13:32', 'Admin', 0),
	(21, 'test0@test.fr', 'test0', '$2y$10$4SoVAwpa7oM.MGOj.F8HmOQ7DHfAE8Ot7fYYRFU13WU3JGURRhw2i', '2022-12-07 20:49:16', 'User', 0),
	(22, 'test_banni@test.fr', 'test_banni', '$2y$10$Xy/J9u1YcmJMF9CLJXH.vebrapL9dtimR01jxQtwsxuyBC9vJMEe2', '2022-12-08 18:37:39', 'User', 1);
